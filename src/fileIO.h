 ...
 *
 * Funzione che ordina i punteggi attraverso un algoritmo
 * Quadratico. E' stato scelto tale algritmo, poco efficente
 ...
 * @return Ritorna l'indice del punteggio minimo.
 */
